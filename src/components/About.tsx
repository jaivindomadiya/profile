  ...
  return (
    <section id="about" className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <h2 className="text-4xl font-bold text-yellow-400 text-center mb-12">About Me</h2>
        <div className="bg-green-800/30 rounded-lg p-8 backdrop-blur-sm border border-yellow-400/20">
